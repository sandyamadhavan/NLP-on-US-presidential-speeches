...
newstring = mycorpus.raw("state_union_part1.txt")
len(newstring)
...
#the resultant is the list of top 50 bigrams by pmi with freq 5
# no further filtering was applied after a manual verification
